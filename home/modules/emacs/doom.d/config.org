...
#+begin_src emacs-lisp
  (defun blw/citar--open-note (keys-entries)
    ...
    ;;        key-entry-alist)))
             ...
             ;; (citar--open-note (car key-entry) (cdr key-entry)))
  ...
  (use-package citar
    ...
    (citar-notes-paths (list (blw/zettelkasten-path "references.bib")))
 ...
 (setq ein:output-area-inlined-images t)
  ...
  (map! :leader
    (:prefix-map ("j" . "jupyter")
      ...
      :desc "Execute all cells"            "A" #'ein:worksheet-execute-all-cells
