...
#+begin_src emacs-lisp
  (setq mu4e-contexts
        `(,(make-mu4e-context
            ...
            :vars '((user-mail-address . "ben@weintraub.xyz")
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c C-m") 'hrs/visit-inbox)
#+end_src
...
* Finish
A little message to let you know that loading is complete
#+begin_src
(message "init.el load complete.")
#+end_src
