...
#+begin_src emacs-lisp
  (setq org-capture-templates
        '(("r" "Reading material"
          ...
          ("z" "Zettel inbox"
           entry
           (file "~/Dropbox/org/zettel-inbox.org")
           "* %?\n")
          ("t" "TODO inbox"
           entry
          ...
          ("f" "Fun projects"
           entry
           (file "~/Dropbox/org/fun-projects.org")
           "* %?\n")))
#+end_src
...
#+begin_src emacs-lisp
  (defun blw/zettel-topics ()
    (interactive)
    (find-file "~/Dropbox/org/zettel-inbox.org"))
  ...
  (defun blw/fun-projects ()
    (interactive)
    (find-file "~/Dropbox/org/fun-projects.org"))

  (global-set-key (kbd "C-c z") 'blw/zettel-topics)
  (global-set-key (kbd "C-c t") 'blw/todos)
  (global-set-key (kbd "C-c f") 'blw/fun-projects)
#+end_src
