...
- I bring up the status menu with =C-x m=.
...
Right now I store everything in a single file called =thebigone.org=. If I
decide to store events and tasks in additional files in the future, I can easily
...
#+RESULTS:
| ~/Documents/org/index.org | ~/Documents/org/events.org | ~/Documents/org/goals.org | ~/Documents/org/recurring-events.org | ~/Documents/org/work.org | ~/Documents/org/thebigone.org |
