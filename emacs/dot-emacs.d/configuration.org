...
#+begin_src emacs-lisp
  (load-file "~/.opt/sensible-defaults.el/sensible-defaults.el")
...
#+begin_src emacs-lisp
  (defun blw/org-roam-graph-firefox (graph)
    ...
    (shell-command "open -a Firefox http://localhost:8080"))
  ...
  (use-package org-roam
    ...
    (org-roam-dailies-capture-templates
     '(("x" "default" entry
        ...
        :head "#+title: %<%Y-%m-%d>\n#+todo: TODO INPROGRESS READ BLOCKED BACKLOG | DONE\n\n* Class\n** Machine Learning                                        :machine_learning:\n** Life of Focus                                              :life_of_focus:\n* Research\n** Tor MIT project                                                   :torcdn:\n** NLP RFC                                                           :nlprfc:\n** pcn delft                                                     :pcncongest:\n** pcn exp cen                                                   :pcnexpcent:\n** Reading                                                          :reading:\n* Misc\n** NDS2                                                                :nds2:\n** Shallow                                                          :shallow:")))
...
I want =mu4e= to connect to the first context (I only have one) at startup.
...
#+begin_src emacs-lisp
        (setq mu4e-contexts
              `(,(make-mu4e-context
                  ...
                  :vars '((user-mail-address . "benweintraub34@gmail.com")
...
Apply any pending changes when leaving the mail buffer.
...
I fetch my email with a [[file:~/.bin/get-new-mail][custom script]] (though, in practice, this is never
...
I check my email pretty often! Probably more than I should. This binds =C-c M-m=
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c M-m") 'hrs/visit-inbox)
#+end_src
