...
plugins=(git z colored-man-pages common-aliases git-auto-fetch golang httpie mvn pip python vagrant virtualenvwrapper web-search cabal)
...
export EMAIL="ben@weintraub.xyz"
