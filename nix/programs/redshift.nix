{
    ...
    # # Your current longitude, between -180.0 and 180.0. Must be provided along
    # # with latitude. Type: null or string. Default: null
    # services.redshift.longitude

    # The location provider to use for determining your location. If set to
    # manual you must also provide latitude/longitude. If set to geoclue2, you
    # must also enable the global geoclue2 service. Type: one of "manual",
    # "geoclue2". Default: "manual"
    services.redshift.provider = "geoclue2";

    # Colour temperature to use during the day, between 1000 and 25000 K. Type:
    # signed integer. Default: 5500
    services.redshift.temperature.day = 5500;

    # Colour temperature to use at night, between 1000 and 25000 K. Type: signed
    # integer. Default: 3700
